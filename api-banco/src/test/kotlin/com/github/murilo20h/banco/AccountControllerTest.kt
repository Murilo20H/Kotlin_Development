...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`() {
        accountRepository.save(Account(name = "Jorge", document = "Texto", phone = "912121212"))
    ...
    @Test
    fun `test find by id`() {
        val account = accountRepository.save(Account(name = "Jorge", document = "Texto", phone = "912121212"))
    ...
    fun `test create account`() {
        val account = Account(name = "Jorge", document = "Texto", phone = "912121212")
    ...
    fun `test update account`() {
        val account = accountRepository
            .save(Account(name = "Jorge", document = "Texto", phone = "912121212"))
            .copy(name = "Murilo")
        val json = ObjectMapper().writeValueAsString(account)
